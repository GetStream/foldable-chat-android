...
import io.getstream.example.windowmanager.chat.compose.R
import io.getstream.example.windowmanager.chat.compose.ui.message.MessagesActivity
import io.getstream.example.windowmanager.chat.compose.ui.message.MessagesScreen
import io.getstream.example.windowmanager.chat.compose.util.WindowSize
...
fun MessagingScreen(
    ...
    when (windowSize) {
        is WindowSize.Expanded -> MessagingScreenExpanded(
            windowSize = windowSize,
